...
if(isset($_POST['update_book'])){
   ...
   $request5 = "UPDATE `book` SET Title=:title,Price=:price,ISBN=:ISBN,Author=:author,Date_Pub=:date,Page_Num=:page,Genre=:genre WHERE IdBook=:update_b_id";
   $idcom=connexpdo('bookstore','myparam');
   ...
   $update_book->bindValue(':update_b_id',$update_b_id, PDO::PARAM_INT);
   $update_book->execute();
